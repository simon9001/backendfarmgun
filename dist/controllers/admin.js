...
import { z } from 'zod';
import { projectSchema, testimonialSchema, tipSchema, blogSchema, serviceSchema, cropSchema, availabilitySchema } from '../utils/validation.js';
...
export class AdminController {
    ...
    // ==================== RESCHEDULE BOOKING ====================
    static async rescheduleBooking(c) {
        try {
            const user = c.get('user');
            if (user.role !== 'admin') {
                return c.json({ error: 'Admin access required' }, 403);
